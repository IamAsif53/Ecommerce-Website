...
function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-[#0F1114]">
      ...
      <div className="absolute -top-40 -left-40 w-[220px] h-[220px] lg:w-[420px] lg:h-[420px] bg-red-500/10 rounded-full blur-[140px]"></div>

      <div className="absolute top-20 right-0 w-[220px] h-[220px] lg:w-[420px] lg:h-[420px] bg-red-600/10 rounded-full blur-[140px]"></div>

      <div className="absolute bottom-0 left-1/2 w-[220px] h-[220px] lg:w-[420px] lg:h-[420px] bg-red-500/10 rounded-full blur-[120px]"></div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-12 lg:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-10 lg:gap-20">
          ...
          <div>
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black leading-tight mt-6 lg:mt-8 text-white">
              Upgrade Your
              <br />
